...
const redTL = gsap.timeline({repeat: 2})
const greenTL = gsap.timeline({repeat: 2})
const blueTL = gsap.timeline({repeat: 2})
const yellowTL = gsap.timeline({repeat: 2})
...
//it needs to repeat make sure it loops after it ends search for property 

// gsap.from(".box.red", {x:-200, duration: 1, y:-200})
